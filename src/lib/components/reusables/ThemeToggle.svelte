<script lang="ts">
  ...
  import { isDarkModeActive, setLyricsTheme, type ThemeChangedEvent } from "../../utils/themeUtils";

  let isDarkModeToggled = $state<boolean>(isDarkModeActive());
...
>
  ...
  <input
    ...
    onchange={function (e) {
      ...
      setLyricsTheme(isDarkModeToggled);
    }}
  />
